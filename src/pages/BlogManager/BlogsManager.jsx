    ...
    return (
        <Box>
            <Box sx={{ display: "flex", justifyContent: "flex-start", gap: 1 }}>
                <NavLink style={styleNavlink} to="danh-sach-bai-viet" className={myStyle.tabContainer}>
                    <Typography>Danh sách</Typography>
                </NavLink>
                <NavLink style={styleNavlink} to="them-bai-viet" className={myStyle.tabContainer}>
